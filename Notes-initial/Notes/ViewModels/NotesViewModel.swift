...
class NotesViewModel: ObservableObject {
  ...
  // MARK: - Persistence
    ...
    func save() throws {
        ...
        try data.write(to: notesFiles)
    }
    
    func load() throws {
        
        guard FileManager.default.isReadableFile(atPath: notesFiles.path) else { return }
        
        
        let data = try Data(contentsOf: notesFiles)
